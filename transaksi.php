...
$query = mysqli_query($conn, "SELECT * FROM pesanan WHERE nama_user = '$nama_user' ORDER BY id_pesanan DESC");
?>
        ...
        <div class="row">
            ...
            <?php 
                ...
                echo '<div class="col-12 text-center mt-5">
                        ...
                        <a href="dashboard.php" class="btn btn-primary">Beli Tiket Sekarang</a>
                      </div>';
            }
            ?>
        </div>
